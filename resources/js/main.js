...
window.onload = function () {
	...
	$(document).ready(function() {
		...
		****************************************************/
        ...
        $('header .department-menu_block.down .department-menu span i').removeClass('fa-angle-up').addClass('fa-angle-down')


        $('header .department-menu').on('click', function(event) {
			$(this).next().slideToggle('100');
			$(this).children('span').children().toggleClass('fa-angle-down fa-angle-up');
		});
		...
		(function($) {
			function mediaSize() {
				if (window.matchMedia('(min-width: 1200px)').matches) {
					...
					// $('header .department-menu_block.down .department-menu span i').removeClass('fa-angle-down').addClass('fa-angle-up')
				}
				else {
		...
		****************************************************/
		...
		// 	$('body').prepend('<div id="quickview"> <div class="quickview-box"> <button class="round-icon-btn" id="quickview-close-btn"><i class="fas fa-times"></i></button> <div class="row"> <div class="col-12 col-md-6"> <div class="shop-detail_img"> <button class="round-icon-btn" id="zoom-btn"><i class="fas fa-search-plus"></i></button> <div class="big-img big-img_qv"> <div class="big-img_block"><img 5555="assets/images/shop/zoom_img_1.png" alt="product image"></div><div class="big-img_block"><img 5555="assets/images/shop/zoom_img_2.png" alt="product image"></div><div class="big-img_block"><img 5555="assets/images/shop/zoom_img_3.png" alt="product image"></div><div class="big-img_block"><img 5555="assets/images/shop/zoom_img_2.png" alt="product image"></div></div><div class="slide-img slide-img_qv"> <div class="slide-img_block"><img 5555="assets/images/shop/zoom_img_1.png" alt="product image"></div><div class="slide-img_block"><img 5555="assets/images/shop/zoom_img_2.png" alt="product image"></div><div class="slide-img_block"><img 5555="assets/images/shop/zoom_img_3.png" alt="product image"></div><div class="slide-img_block"><img 5555="assets/images/shop/zoom_img_2.png" alt="product image"></div></div></div></div><div class="col-12 col-md-6"> <div class="shop-detail_info"> <h5 class="product-type color-type">Oranges</h5><a class="product-name" href="shop_detail.html">Pure Pineapple</a> <div class="price-rate"> <h3 class="product-price"> <del>$35.00</del>$14.00 </h3> </div><p class="product-describe"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Provident vero saepe nihil nisi ipsum officiis, tempora reiciendis, rerum ipsa aliquid, repudiandae expedita placeat, vel quae commodi sequi. Repellat, laudantium voluptas.</p><div class="quantity-select"> <label for="quantity">Quatity:</label> <input class="no-round-input" id="quantity" type="number" min="0" value="1"> </div><div class="product-select"> <button class="add-to-cart normal-btn outline">Add to Cart</button> <button class="add-to-compare normal-btn outline">+ Add to Compare</button> </div><div class="product-share"> <h5>Share link:</h5><a href=""><i class="fab fa-facebook-f"> </i></a><a href=""><i class="fab fa-twitter"></i></a><a href=""><i class="fab fa-invision"> </i></a><a href=""><i class="fab fa-pinterest-p"></i></a> </div></div></div></div></div></div>')
